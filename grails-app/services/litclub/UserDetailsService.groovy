...
class UserDetailsService implements GrailsUserDetailsService {
  ...
  UserDetails loadUserByUsername(String username, boolean loadRoles) {
    ...
    Person user = personDao.getByDomain(username)
  ...
  protected UserDetails createUserDetails(Person user, Collection authorities) {
    new GrailsUser(user.domain, user.password, user.enabled,
