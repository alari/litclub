 ...
 */
class UserController extends litclub.s2ui.AbstractS2UiController {
	...
	def save = {
		def user = lookupUserClass().newInstance(params)
		if (params.password) {
			String salt = saltSource instanceof NullSaltSource ? null : params.domain
	...
	def update = {
		...
		addRoles user
		userCache.removeUserFromCache user.domain
