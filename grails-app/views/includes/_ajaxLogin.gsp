...
<div id="loginFormContainer" style='display:none' title="${message(code:'spring.security.ui.login.signin')}">
	<g:form controller='${SpringSecurityUtils.getSecurityConfig().apf.filterProcessesUrl}' name="loginForm" autocomplete='off'>

	<label for="username"><g:message code='spring.security.ui.login.username'/></label>
	<input class='login' name="${SpringSecurityUtils.getSecurityConfig().apf.usernameParameter}" id="username" size="20" />

	<label for="password"><g:message code='spring.security.ui.login.password'/></label>
	<input class='login'type="password" name="${SpringSecurityUtils.getSecurityConfig().apf.passwordParameter}" id="password" size="20" />

	<input type="checkbox" class="checkbox" name="${SpringSecurityUtils.getSecurityConfig().rememberMe.parameter}" id="remember_me" checked="checked" />
	...
	<g:link controller='personRegister'><g:message code='spring.security.ui.login.register'/></g:link>
