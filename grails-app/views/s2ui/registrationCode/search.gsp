...
%>
	...
	<table>
		...
		<tr>
			...
			<g:sortableColumn property="user.username" title="${message(code: 'registrationCode.domain.label', default: 'Username')}" params="${queryParams}"/>
		...
		<tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
			...
			<td><g:link controller='user' action='edit' params='[username: registrationCode.username]'>${fieldValue(bean: registrationCode, field: "domain")}</g:link></td>
